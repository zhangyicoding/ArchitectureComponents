...
import com.estyle.app_room.viewmodel.RxUserViewModel;
import com.estyle.app_room.viewmodel.UserViewModel;
import com.estyle.app_room.zhangyi.ZYLog;

import java.util.List;

public class RxRoomActivity extends AppCompatActivity implements View.OnClickListener {

    private static final String TAG = RxRoomActivity.class.getSimpleName();
    ...
    private RxUserViewModel mViewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this, new ViewModelProvider.Factory() {
            ...
            public <T extends ViewModel> T create(@NonNull Class<T> modelClass) {
                return (T) new RxUserViewModel();
            }
        }).get(RxUserViewModel.class);
