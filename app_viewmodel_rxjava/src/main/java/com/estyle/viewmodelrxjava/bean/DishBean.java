package com.estyle.viewmodelrxjava.bean;
...
public class DishBean {
    ...
    public static class DataBean {
        ...
        public String getCollect_num() { return collect_num;}

        public void setCollect_num(String collect_num) { this.collect_num = collect_num;}

        public String getFood_str() { return food_str;}

        public void setFood_str(String food_str) { this.food_str = food_str;}
